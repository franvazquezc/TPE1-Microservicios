package com.tudai.arquitecturasweb.microserviciomonopatines.entity;
...
public class Monopatin {
    ...
    public Monopatin(boolean activo, EstadoMonopatin estado, Double minutosDeUso, Double kmRecorridos, Double latitud, Double longitud) {
        this.activo = activo;
        this.estado = estado;
